...
function preload(){
  ...
  balasana=loadImage("balasana.png");
  balasana_steps=loadImage("balasana steps.png");
}
...
function draw(){
 ...
 image(sukhasana_steps,displayWidth-450,166,300,400);
  ...
  background("pink");
   ...
   textSize(30)
   textStyle(BOLD);
   text("BALASANA (CHILD'S POSE)",displayWidth-900,100)
   image(balasana,displayWidth-700,200,500,300);
   image(balasana_steps,displayWidth-1400,150,800,500);
}
else if(gameState===5){
